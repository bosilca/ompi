...
int mca_coll_ucc_alltoall(ompi_coll_args_t *args, struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    COLL_UCC_CHECK(mca_coll_ucc_alltoall_init_common(args->src.info.buffer, args->src.info.count, args->src.info.datatype,
...
fallback:
    ...
    return ucc_module->previous_alltoall(args, comm, ucc_module->previous_alltoall_module);
}
...
fallback:
    ...
    return ucc_module->previous_ialltoall(args, comm, request,
...
fallback:
    ...
    return ucc_module->previous_alltoall_init(args, comm, info, request,
