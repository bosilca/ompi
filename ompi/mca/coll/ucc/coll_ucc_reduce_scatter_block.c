...
int mca_coll_ucc_reduce_scatter_block(ompi_coll_args_t *args, struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    COLL_UCC_CHECK(mca_coll_ucc_reduce_scatter_block_init_common(args->src.info.buffer, args->dst.info.buffer, args->dst.info.count,
                                                                 args->dst.info.datatype, args->op, false, ucc_module,
                                                                 &req, NULL));
...
fallback:
    ...
    return ucc_module->previous_reduce_scatter_block(args, comm,
...
fallback:
    ...
    return ucc_module->previous_ireduce_scatter_block(args, comm, request,
...
int mca_coll_ucc_reduce_scatter_block_init(ompi_coll_args_t *args, struct ompi_communicator_t *comm, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module)
{
    ...
    COLL_UCC_CHECK(mca_coll_ucc_reduce_scatter_block_init_common(args->src.info.buffer, args->dst.info.buffer, args->dst.info.count,
                                                                 args->dst.info.datatype, args->op, true, ucc_module,
                                                                 &req, coll_req));
    *request = &coll_req->super;
    return OMPI_SUCCESS;
fallback:
    ...
    return ucc_module
        ->previous_reduce_scatter_block_init(args, comm, info, request,
