...
OBJ_CLASS_INSTANCE(mca_coll_adapt_allreduce_generic_context_t, opal_free_list_item_t, mca_coll_adapt_allreduce_generic_context_constructor, mca_coll_adapt_allreduce_generic_context_destructor);
