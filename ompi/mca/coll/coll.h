...
struct mca_coll_base_module_4_0_0_t;
 ...
 */
typedef struct mca_coll_base_module_4_0_0_t *
  (*mca_coll_base_component_comm_query_4_0_0_fn_t)
 ...
 */
typedef int
(*mca_coll_base_module_enable_1_1_0_fn_t)(struct mca_coll_base_module_4_0_0_t* module,
                                          struct ompi_communicator_t *comm);

/*
 * Unified collective module signatures.
 *
 * Every collective payload is carried in a single ompi_coll_args_t (see
 * coll_args.h); the communicator, info and request are explicit
 * parameters. There are three shapes, by completion semantics:
 *
 *   - coll_fn_t       blocking     (args, comm, module)
 *   - icoll_fn_t      nonblocking  (args, comm, request, module)
 *   - coll_init_fn_t  persistent   (args, comm, info, request, module)
 *
 * All the per-collective typedefs below are aliases onto one of these so
 * the module / comm_coll tables keep one NULL-able pointer per collective
 * (NULL still means "this module does not provide that collective").
 */
typedef int (*mca_coll_base_module_coll_fn_t)
  (ompi_coll_args_t *args, struct ompi_communicator_t *comm,
   struct mca_coll_base_module_4_0_0_t *module);
typedef int (*mca_coll_base_module_icoll_fn_t)
  (ompi_coll_args_t *args, struct ompi_communicator_t *comm,
   ompi_request_t **request, struct mca_coll_base_module_4_0_0_t *module);
typedef int (*mca_coll_base_module_coll_init_fn_t)
  (ompi_coll_args_t *args, struct ompi_communicator_t *comm,
 ...
 * contrib/dt_count/dtype live in args->src.info, op in args->op, and the
 * failed group in args->failedgroup (with FLAG_UPDATE_FAILEDGROUP). */
typedef mca_coll_base_module_coll_fn_t  mca_coll_base_module_agree_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iagree_fn_t;
 ...
 */
typedef int
(*mca_coll_base_module_disable_1_2_0_fn_t)(struct mca_coll_base_module_4_0_0_t* module,
                                          struct ompi_communicator_t *comm);

/* blocking collectives: all share the (args, comm, module) signature */
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_allgather_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_allgatherv_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_allreduce_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_alltoall_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_alltoallv_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_alltoallw_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_barrier_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_bcast_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_exscan_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_gather_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_gatherv_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_reduce_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_reduce_scatter_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_reduce_scatter_block_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_scan_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_scatter_fn_t;
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_scatterv_fn_t;

/* nonblocking collectives: all share the (args, comm, request, module) signature */
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iallgather_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iallgatherv_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iallreduce_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ialltoall_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ialltoallv_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ialltoallw_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ibarrier_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ibcast_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iexscan_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_igather_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_igatherv_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ireduce_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ireduce_scatter_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_ireduce_scatter_block_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iscan_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iscatter_fn_t;
typedef mca_coll_base_module_icoll_fn_t mca_coll_base_module_iscatterv_fn_t;

/* persistent collectives: all share the (args, comm, info, request, module) signature */
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_allgather_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_allgatherv_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_allreduce_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_alltoall_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_alltoallv_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_alltoallw_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_barrier_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_bcast_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_exscan_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_gather_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_gatherv_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_reduce_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_reduce_scatter_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_reduce_scatter_block_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_scan_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_scatter_init_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_scatterv_init_fn_t;

/*
 * Neighborhood alltoallw shares the same signatures; the per-peer datatype
 * arrays live in args->src.info_v.datatypes / args->dst.info_v.datatypes.
 */
typedef mca_coll_base_module_coll_fn_t      mca_coll_base_module_neighbor_alltoallw_fn_t;
typedef mca_coll_base_module_icoll_fn_t     mca_coll_base_module_ineighbor_alltoallw_fn_t;
typedef mca_coll_base_module_coll_init_fn_t mca_coll_base_module_neighbor_alltoallw_init_fn_t;
 ...
 * option of intercepting it, if desired. inbuf/inoutbuf/count/dtype/op live
 * in args; the comm parameter is unused (callers pass comm_self).
 */
typedef mca_coll_base_module_coll_fn_t mca_coll_base_module_reduce_local_fn_t;
 ...
 * component.
 */
struct mca_coll_base_component_4_0_0_t {
    ...
    mca_coll_base_component_comm_query_4_0_0_fn_t collm_comm_query;
};
typedef struct mca_coll_base_component_4_0_0_t mca_coll_base_component_4_0_0_t;
...
/** Per guidance in mca.h, use the unversioned struct name if you just
    ...
    interface. */
typedef struct mca_coll_base_component_4_0_0_t mca_coll_base_component_t;
...
typedef struct mca_coll_base_module_4_0_0_t mca_coll_base_module_4_0_0_t;

/** Per guidance in mca.h, use the unversioned struct name if you just
    want to always keep up with the most recent version of the
    interface. */
typedef struct mca_coll_base_module_4_0_0_t mca_coll_base_module_t;
...
struct mca_coll_base_comm_coll_t {
    ...
    mca_coll_base_module_allgather_fn_t coll_allgather;
    mca_coll_base_module_4_0_0_t *coll_allgather_module;
    mca_coll_base_module_allgatherv_fn_t coll_allgatherv;
    mca_coll_base_module_4_0_0_t *coll_allgatherv_module;
    mca_coll_base_module_allreduce_fn_t coll_allreduce;
    mca_coll_base_module_4_0_0_t *coll_allreduce_module;
    mca_coll_base_module_alltoall_fn_t coll_alltoall;
    mca_coll_base_module_4_0_0_t *coll_alltoall_module;
    mca_coll_base_module_alltoallv_fn_t coll_alltoallv;
    mca_coll_base_module_4_0_0_t *coll_alltoallv_module;
    mca_coll_base_module_alltoallw_fn_t coll_alltoallw;
    mca_coll_base_module_4_0_0_t *coll_alltoallw_module;
    mca_coll_base_module_barrier_fn_t coll_barrier;
    mca_coll_base_module_4_0_0_t *coll_barrier_module;
    mca_coll_base_module_bcast_fn_t coll_bcast;
    mca_coll_base_module_4_0_0_t *coll_bcast_module;
    mca_coll_base_module_exscan_fn_t coll_exscan;
    mca_coll_base_module_4_0_0_t *coll_exscan_module;
    mca_coll_base_module_gather_fn_t coll_gather;
    mca_coll_base_module_4_0_0_t *coll_gather_module;
    mca_coll_base_module_gatherv_fn_t coll_gatherv;
    mca_coll_base_module_4_0_0_t *coll_gatherv_module;
    mca_coll_base_module_reduce_fn_t coll_reduce;
    mca_coll_base_module_4_0_0_t *coll_reduce_module;
    mca_coll_base_module_reduce_scatter_fn_t coll_reduce_scatter;
    mca_coll_base_module_4_0_0_t *coll_reduce_scatter_module;
    mca_coll_base_module_reduce_scatter_block_fn_t coll_reduce_scatter_block;
    mca_coll_base_module_4_0_0_t *coll_reduce_scatter_block_module;
    mca_coll_base_module_scan_fn_t coll_scan;
    mca_coll_base_module_4_0_0_t *coll_scan_module;
    mca_coll_base_module_scatter_fn_t coll_scatter;
    mca_coll_base_module_4_0_0_t *coll_scatter_module;
    mca_coll_base_module_scatterv_fn_t coll_scatterv;
    mca_coll_base_module_4_0_0_t *coll_scatterv_module;

    /* nonblocking collectives */
    mca_coll_base_module_iallgather_fn_t coll_iallgather;
    mca_coll_base_module_4_0_0_t *coll_iallgather_module;
    mca_coll_base_module_iallgatherv_fn_t coll_iallgatherv;
    mca_coll_base_module_4_0_0_t *coll_iallgatherv_module;
    mca_coll_base_module_iallreduce_fn_t coll_iallreduce;
    mca_coll_base_module_4_0_0_t *coll_iallreduce_module;
    mca_coll_base_module_ialltoall_fn_t coll_ialltoall;
    mca_coll_base_module_4_0_0_t *coll_ialltoall_module;
    mca_coll_base_module_ialltoallv_fn_t coll_ialltoallv;
    mca_coll_base_module_4_0_0_t *coll_ialltoallv_module;
    mca_coll_base_module_ialltoallw_fn_t coll_ialltoallw;
    mca_coll_base_module_4_0_0_t *coll_ialltoallw_module;
    mca_coll_base_module_ibarrier_fn_t coll_ibarrier;
    mca_coll_base_module_4_0_0_t *coll_ibarrier_module;
    mca_coll_base_module_ibcast_fn_t coll_ibcast;
    mca_coll_base_module_4_0_0_t *coll_ibcast_module;
    mca_coll_base_module_iexscan_fn_t coll_iexscan;
    mca_coll_base_module_4_0_0_t *coll_iexscan_module;
    mca_coll_base_module_igather_fn_t coll_igather;
    mca_coll_base_module_4_0_0_t *coll_igather_module;
    mca_coll_base_module_igatherv_fn_t coll_igatherv;
    mca_coll_base_module_4_0_0_t *coll_igatherv_module;
    mca_coll_base_module_ireduce_fn_t coll_ireduce;
    mca_coll_base_module_4_0_0_t *coll_ireduce_module;
    mca_coll_base_module_ireduce_scatter_fn_t coll_ireduce_scatter;
    mca_coll_base_module_4_0_0_t *coll_ireduce_scatter_module;
    mca_coll_base_module_ireduce_scatter_block_fn_t coll_ireduce_scatter_block;
    mca_coll_base_module_4_0_0_t *coll_ireduce_scatter_block_module;
    mca_coll_base_module_iscan_fn_t coll_iscan;
    mca_coll_base_module_4_0_0_t *coll_iscan_module;
    mca_coll_base_module_iscatter_fn_t coll_iscatter;
    mca_coll_base_module_4_0_0_t *coll_iscatter_module;
    mca_coll_base_module_iscatterv_fn_t coll_iscatterv;
    mca_coll_base_module_4_0_0_t *coll_iscatterv_module;

    /* persistent collectives */
    mca_coll_base_module_allgather_init_fn_t coll_allgather_init;
    mca_coll_base_module_4_0_0_t *coll_allgather_init_module;
    mca_coll_base_module_allgatherv_init_fn_t coll_allgatherv_init;
    mca_coll_base_module_4_0_0_t *coll_allgatherv_init_module;
    mca_coll_base_module_allreduce_init_fn_t coll_allreduce_init;
    mca_coll_base_module_4_0_0_t *coll_allreduce_init_module;
    mca_coll_base_module_alltoall_init_fn_t coll_alltoall_init;
    mca_coll_base_module_4_0_0_t *coll_alltoall_init_module;
    mca_coll_base_module_alltoallv_init_fn_t coll_alltoallv_init;
    mca_coll_base_module_4_0_0_t *coll_alltoallv_init_module;
    mca_coll_base_module_alltoallw_init_fn_t coll_alltoallw_init;
    mca_coll_base_module_4_0_0_t *coll_alltoallw_init_module;
    mca_coll_base_module_barrier_init_fn_t coll_barrier_init;
    mca_coll_base_module_4_0_0_t *coll_barrier_init_module;
    mca_coll_base_module_bcast_init_fn_t coll_bcast_init;
    mca_coll_base_module_4_0_0_t *coll_bcast_init_module;
    mca_coll_base_module_exscan_init_fn_t coll_exscan_init;
    mca_coll_base_module_4_0_0_t *coll_exscan_init_module;
    mca_coll_base_module_gather_init_fn_t coll_gather_init;
    mca_coll_base_module_4_0_0_t *coll_gather_init_module;
    mca_coll_base_module_gatherv_init_fn_t coll_gatherv_init;
    mca_coll_base_module_4_0_0_t *coll_gatherv_init_module;
    mca_coll_base_module_reduce_init_fn_t coll_reduce_init;
    mca_coll_base_module_4_0_0_t *coll_reduce_init_module;
    mca_coll_base_module_reduce_scatter_init_fn_t coll_reduce_scatter_init;
    mca_coll_base_module_4_0_0_t *coll_reduce_scatter_init_module;
    mca_coll_base_module_reduce_scatter_block_init_fn_t coll_reduce_scatter_block_init;
    mca_coll_base_module_4_0_0_t *coll_reduce_scatter_block_init_module;
    mca_coll_base_module_scan_init_fn_t coll_scan_init;
    mca_coll_base_module_4_0_0_t *coll_scan_init_module;
    mca_coll_base_module_scatter_init_fn_t coll_scatter_init;
    mca_coll_base_module_4_0_0_t *coll_scatter_init_module;
    mca_coll_base_module_scatterv_init_fn_t coll_scatterv_init;
    mca_coll_base_module_4_0_0_t *coll_scatterv_init_module;

    /* blocking neighborhood collectives */
    mca_coll_base_module_allgather_fn_t coll_neighbor_allgather;
    mca_coll_base_module_4_0_0_t *coll_neighbor_allgather_module;
    mca_coll_base_module_allgatherv_fn_t coll_neighbor_allgatherv;
    mca_coll_base_module_4_0_0_t *coll_neighbor_allgatherv_module;
    mca_coll_base_module_alltoall_fn_t coll_neighbor_alltoall;
    mca_coll_base_module_4_0_0_t *coll_neighbor_alltoall_module;
    mca_coll_base_module_alltoallv_fn_t coll_neighbor_alltoallv;
    mca_coll_base_module_4_0_0_t *coll_neighbor_alltoallv_module;
    mca_coll_base_module_neighbor_alltoallw_fn_t coll_neighbor_alltoallw;
    mca_coll_base_module_4_0_0_t *coll_neighbor_alltoallw_module;

    /* nonblocking neighborhood collectives */
    mca_coll_base_module_iallgather_fn_t coll_ineighbor_allgather;
    mca_coll_base_module_4_0_0_t *coll_ineighbor_allgather_module;
    mca_coll_base_module_iallgatherv_fn_t coll_ineighbor_allgatherv;
    mca_coll_base_module_4_0_0_t *coll_ineighbor_allgatherv_module;
    mca_coll_base_module_ialltoall_fn_t coll_ineighbor_alltoall;
    mca_coll_base_module_4_0_0_t *coll_ineighbor_alltoall_module;
    mca_coll_base_module_ialltoallv_fn_t coll_ineighbor_alltoallv;
    mca_coll_base_module_4_0_0_t *coll_ineighbor_alltoallv_module;
    mca_coll_base_module_ineighbor_alltoallw_fn_t coll_ineighbor_alltoallw;
    mca_coll_base_module_4_0_0_t *coll_ineighbor_alltoallw_module;

    /* persistent neighborhood collectives */
    mca_coll_base_module_allgather_init_fn_t coll_neighbor_allgather_init;
    mca_coll_base_module_4_0_0_t *coll_neighbor_allgather_init_module;
    mca_coll_base_module_allgatherv_init_fn_t coll_neighbor_allgatherv_init;
    mca_coll_base_module_4_0_0_t *coll_neighbor_allgatherv_init_module;
    mca_coll_base_module_alltoall_init_fn_t coll_neighbor_alltoall_init;
    mca_coll_base_module_4_0_0_t *coll_neighbor_alltoall_init_module;
    mca_coll_base_module_alltoallv_init_fn_t coll_neighbor_alltoallv_init;
    mca_coll_base_module_4_0_0_t *coll_neighbor_alltoallv_init_module;
    mca_coll_base_module_neighbor_alltoallw_init_fn_t coll_neighbor_alltoallw_init;
    mca_coll_base_module_4_0_0_t *coll_neighbor_alltoallw_init_module;

    mca_coll_base_module_reduce_local_fn_t coll_reduce_local;
    mca_coll_base_module_4_0_0_t *coll_reduce_local_module;

    mca_coll_base_module_agree_fn_t coll_agree;
    mca_coll_base_module_4_0_0_t *coll_agree_module;
    mca_coll_base_module_iagree_fn_t coll_iagree;
    mca_coll_base_module_4_0_0_t *coll_iagree_module;
 ...
 */
#define MCA_COLL_BASE_VERSION_4_0_0 \
    OMPI_MCA_BASE_VERSION_2_1_0("coll", 4, 0, 0)
