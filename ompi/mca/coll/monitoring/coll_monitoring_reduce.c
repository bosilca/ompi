...
int mca_coll_monitoring_reduce(ompi_coll_args_t *args, struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_reduce(args, comm, monitoring_module->real.coll_reduce_module);
}

int mca_coll_monitoring_ireduce(ompi_coll_args_t *args, struct ompi_communicator_t *comm, ompi_request_t **request, mca_coll_base_module_t *module)
{
    mca_coll_monitoring_module_t*monitoring_module = (mca_coll_monitoring_module_t*) module;
    if( args->root == ompi_comm_rank(comm) ) {
        int i, rank;
    ...
    return monitoring_module->real.coll_ireduce(args, comm, request, monitoring_module->real.coll_ireduce_module);
}
