...
int mca_coll_monitoring_neighbor_allgather(ompi_coll_args_t *args, struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_neighbor_allgather(args, comm, monitoring_module->real.coll_neighbor_allgather_module);
}

int mca_coll_monitoring_ineighbor_allgather(ompi_coll_args_t *args, struct ompi_communicator_t *comm, ompi_request_t **request, mca_coll_base_module_t *module)
{
    mca_coll_monitoring_module_t*monitoring_module = (mca_coll_monitoring_module_t*) module;
    size_t type_size, data_size, data_size_aggreg = 0;
    const mca_topo_base_comm_cart_t *cart = comm->c_topo->mtc.cart;
    ...
    return monitoring_module->real.coll_ineighbor_allgather(args, comm, request, monitoring_module->real.coll_ineighbor_allgather_module);
}
