...
int ompi_coll_tuned_alltoallv_intra_do_this(ompi_coll_args_t *args, struct ompi_communicator_t *comm, mca_coll_base_module_t *module,
                                            int algorithm)
{
    ...
    case (1):
        return ompi_coll_base_alltoallv_intra_basic_linear(args, comm, module);
    case (2):
        return ompi_coll_base_alltoallv_intra_pairwise(args, comm, module);
    }  /* switch */
    OPAL_OUTPUT_VERBOSE((COLL_TUNED_TRACING_VERBOSE, ompi_coll_tuned_stream,
