...
int
ompi_coll_portals4_scatter_intra(ompi_coll_args_t *args, struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    int ret, line;
     ...
     */
    ret = ompi_coll_portals4_scatter_intra_linear_top(args->src.info.buffer, args->src.info.count, args->src.info.datatype,
...
int
ompi_coll_portals4_iscatter_intra(ompi_coll_args_t *args, struct ompi_communicator_t *comm, ompi_request_t **request, mca_coll_base_module_t *module)
{
    ...
    *ompi_request = &p4_request->super;
    p4_request->u.scatter.is_sync = 0;
    ...
    OPAL_OUTPUT_VERBOSE((10, ompi_coll_base_framework.framework_output,
                 "coll:portals4:iscatter_intra exit rank %d", p4_request->u.scatter.my_rank));
...
err_hdlr:
    opal_output(ompi_coll_base_framework.framework_output,
            "%s:%4d:%4d\tError occurred ret=%d, rank %2d",
            __FILE__, __LINE__, line, ret, p4_request->u.scatter.my_rank);
